...
export function CardDisplayContainer() {
  ...
  const oldCards = typeof window !== 'undefined' ? localStorage.getItem('savedCards') : null;
  const newCards = typeof window !== 'undefined' ? localStorage.getItem('business_cards') : null;
  ...
  return <MobileCardLayout card={card} onNavigateBack={() => router.back()} />;
}
